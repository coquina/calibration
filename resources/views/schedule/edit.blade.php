...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2><a  href="{{ route('schedule.index') }}"> <font color="black">排程管理 </font></a> <font size="5"><span class="glyphicon glyphicon-menu-right"></span></font> 校驗結果輸入</h2>
        </div>
    </div>
</div>
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="form-group">
                ...
                {{--{!! Form::file('TestResult_raw_file', null, array('placeholder' => '檢測結果原始檔','class' => 'form-control')) !!}--}}
            </div>
        </div>
