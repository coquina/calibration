...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'Machine_prices'        =>'機器價格',
        'Service_life'          =>'使用年限',
        'Instrument_sort'       =>'儀器分類',
        'Purchasing_department' =>'採購部門',
        'Manfaucturer'          =>'製造廠商',
        'Model'                 =>'型號',
        'Standard_no'           =>'規範編號',
        'Standard_name'         =>'規範名稱',
        'File_norm'             =>'原始文件規範檔名',
        'File_norm_code'        =>'系統文件規範編碼',
        'Cycle_R'               =>'建議週期',
        'S_Department'          =>'規範所屬單位',
        'Issuse_Department'     =>'發行單位',
        'Citation'              =>'引用出處',
        'Version'               =>'版次',
        'Standard_Status'       =>'規範狀態',
        'Project_name'          =>'計劃名稱',
        'Check_method'          =>'校驗方式',
        'Cycle'                 =>'週期',
        'TestResult_raw_file '  =>'檢測結果原始檔',
        'Applicant'             =>'申請者',
        'Correction_company'    =>'校正廠商',
        'Serial_Number'         =>'序號',
        'Procedure_Used'        =>'校正程序',
        'Received_Date'         =>'收件日期',
        'Temperature'           =>'溫度',
        'Relative_Humidity'     =>'相對溫度',
        'Consumer_Address '     =>'顧客地址',
        'Location'              =>'校正地點',
        'Traceability'          =>'追溯單位',
        'Report_No'             =>'報告號碼',
        'Due_Date'              =>'標準器有效日期',
